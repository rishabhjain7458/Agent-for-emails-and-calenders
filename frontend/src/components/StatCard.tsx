      ...
      <CardContent>
        <Stack spacing={1.25}>
          <Stack direction="row" alignItems="center" justifyContent="space-between" spacing={1}>
            ...
            {icon && (
              <Box sx={{ width: 36, height: 36, display: 'grid', placeItems: 'center', borderRadius: 2, bgcolor: `${accent}18`, color: accent, transition: 'transform 180ms ease', '.metric-card:hover &': { transform: 'rotate(-4deg) scale(1.06)' } }}>
                {icon}
              </Box>
            )}
          </Stack>
